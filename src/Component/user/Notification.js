...
import img1 from '../Assessts/star.png'; // Fixed typo in the import path
import img2 from '../Assessts/bell.png'
  ...
  const cartItemsData = [
    {
      ...
      "name": "Recipe Update",
      "image": img1,
      "description": "Weekly New Recipes! Discover our new recipes of the week!"
    },
    {
      "id": 2,
      "name": "Event Reminder",
    ...
    },
    {
      "id": 3,
      "name": "Special Offer",
      "image": "https://example.com/images/special-offer.png",
      "description": "Special offer on all recipe books this week only!"
    },
    {
      "id": 4,
      "name": "Community Post",
      "image": "https://example.com/images/community-post.png",
...
/>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', ml: 0.5, maxWidth: 'calc(100% - 65px)' }}>
                <Typography
                  sx={{
